...
export const Header = () => {
    const onClick = async () => {
        ...
        // b("show", false);
        await NUI.execute("bugs:close");
        await NUI.execute("bugs:viewRefunds");
    };
    return (
        <div
            class="_header_jjrit_1"
        >
            <div
                class="_main_content_jjrit_8"
            >
                <svg
                    width="4.53vh"
                    height="4.53vh"
                ...
                >
                    <div
                        class="_title_jjrit_12"
                    >BUG REPORT</div>
                    <div
                        class="_description_jjrit_21"
                    >PLEASE FILL OUT THE FORM BELOW TO REPORT A BUG.</div>
                </div>
            </div>
            <div
                class="_actions_jjrit_29"
            >
                <div
                    class="_refund_cta_jjrit_34"
                    onClick={onClick}
                >
                    Refunds
                    <Show
                        when={state.pendingItemRefunds && state.pendingItemRefunds > 0}
                    >
                        <span
                            class="_notif_circle_jjrit_54"
                        >
                            {state.pendingItemRefunds}
                        </span>
                    </Show>
                </div>
                <div
                    class="_keybind_jjrit_68"
                >
                    <div
                        class="_text_jjrit_81"
                    >Exit</div>
                    <div
                        class="_button_jjrit_84"
                    >ESC</div>
                </div>
            </div>
        </div>
